		...
		<div class="container">
			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<form method="post"
						action="${pageContext.request.contextPath}/satellite/list"
						class="row g-3">


						<div class="col-md-6">
							<label for="denominazione" class="form-label">Denominazione
							</label> <input type="text" name="denominazione" id="denominazione"
								class="form-control" placeholder="Inserire la denominazione">
						</div>
						...
						<div class="col-md-3">
							...
							</label> <input class="form-control" id="dataLancio" type="date"
						...
						<div class="col-md-3">
							<label for="dataRientro" class="form-label">Data di
								Rientro </label> <input class="form-control" id="dataRientro"
